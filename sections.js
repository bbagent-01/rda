...
export const NAV_ITEMS = [
  ...
  ['5','Trigger'], ['6','Scrub'], ['7','Ribbons'], ['8','Podium'], ['9','Shards'], ['10','Tilt'], ['11','Iris'], ['12','Iris II'], ['13','Amphitheater']
];
const PRIMARY = ['5', '9', '10', '11', '12', '13'];   // everything else lives in the Archive dropdown

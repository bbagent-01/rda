...
export const NAV_ITEMS = [
  ...
  ['5','Trigger'], ['6','Scrub'], ['7','Ribbons'], ['8','Podium'], ['9','Shards'], ['10','Tilt'], ['11','Iris'], ['12','Iris II'], ['13','Amphitheater'], ['14','Ribbons II'], ['15','Spectrum']
];
const PRIMARY = ['5', '10', '13', '14', '15'];   // everything else (incl. archived 9/11/12) lives in the Archive dropdown
